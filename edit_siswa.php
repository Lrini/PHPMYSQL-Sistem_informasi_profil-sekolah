...
<?php 
	...
	$nis  =$_GET['nis'];
    $data = mysql_query("SELECT * FROM t_siswa where nis= '$nis'");
 ...
 ?>
    <table class="table table-bordered">
        ...
        <tr>
          ...
          <td>
            <div class='col-sm-4'>
              <input type='text' name='nama' value="<?php echo $edit['nama'] ?>"  class='form-control' required='required' >
            </div>  
		  </td>
...
if(isset($_POST['edit'])){
    ...
    $sql = mysql_query("UPDATE t_siswa set nama='$nama' where nis='$nis'");
    ...
    if($sql){
		...
		?>
        <script type="text/javascript">
            alert("gagal");window.location='tabel_siswa.php';
        </script>
        <?php
	}
