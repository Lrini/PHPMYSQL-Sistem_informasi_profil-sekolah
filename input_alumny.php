...
if(isset($_POST['simpan'])){
   ...
   $nama_alumny =$_POST['nama_alumny'];
   $nama_sekolah =$_POST ['nama_sekolah'];
   $alamat =$_POST['alamat'];
   $Tahun=$_POST['Tahun'];
	
    $sql = mysql_query("INSERT INTO alumny(nama_alumny,nama_sekolah,alamat,Tahun)values 
		('$nama_alumny','$nama_sekolah','$alamat','$Tahun')");
    if($sql){
        ?>
        <script type="text/javascript">
...
<div class="tab-pane active" id="biodata">
    <table class="table table-bordered">
      ...
      <tr>
          ...
          <td>
              <div class="col-md-4">
              <input type='text' name='nama_alumny' placeholder='' class='form-control'  value='' >
              </div>
            </td>
        </tr>
		 <tr>
          ...
          <td>
              <div class="col-md-4">
              <input type='text' name='nama_sekolah' placeholder='' class='form-control'  value='' >
              </div>
            </td>
        </tr>
		<tr>
          <td>Alamat</td>
            ...
            <td><textarea name="alamat" id="news"></textarea>
            <script type="text/javascript">
		...
		<tr>
          ...
          <td>
              <div class="col-md-4">
              <input type='text' name='Tahun' placeholder='' class='form-control'  value='' >
              </div>
            </td>
        </tr>
    </table>
