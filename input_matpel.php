...
if(isset($_POST['simpan'])){
    ...
    $sql = mysql_query("INSERT INTO t_matpel(kode_matpel,matpel)values 
		('$kode_matpel','$matpel')");
    if($sql){
        ?>
        <script type="text/javascript">
...
<div class="tab-pane active" id="biodata">
    <table class="table table-bordered">
        <tr class="success"><th colspan="2">INPUT DATA MATAPELAJARAN</th></tr>
      <tr>
          <td>Kode Mata Pelajaran</td>
          <td>
              <div class="col-md-4">
              <input type='text' name='kode_matpel' placeholder='' class='form-control'  value='' >
              </div>
            </td>
        </tr>
			 <tr>
          ...
          <td>
              <div class="col-md-4">
              <input type='text' name='matpel' placeholder='' class='form-control'  value='' >
              </div>
            </td>
        </tr>
    </table>
