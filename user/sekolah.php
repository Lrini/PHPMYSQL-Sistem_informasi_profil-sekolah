	...
	<div class="body-content">
		<div class="container">
						...
						<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
							<nav class="stroke">
								<ul class="nav navbar-nav">
									<li><a href="index1.php" class="hvr-rectangle-out">Home</a></li>
									<li><a href="gallery.php" class="hvr-rectangle-out">Gallery</a></li>
										<li class="active"><a href="Alumny.php">Alumny</a></li>
								</ul>
							</nav>
						</div>
						<!-- /.navbar-collapse -->
			...
			<!-- banner -->
				...
				<div class="services">
					<h2>Sekolah Dasar Kristen Citra Bangsa</h2>
					<div class="services-grids">
						<div class="col-md-4 services-grid-left">
							<img src="images/16.jpg" alt=" " class="img-responsive" />
						</div>
						<div class="col-md-8 services-grid-right">
							<h3>Visi<span> dan Misi</span></h3>
							<p>visi :</p>
							<h4><i>"Setiap detik yang kita lalui dalam hidup sangat berharga, begitu pula pilar - pilar kenangan membuat kita lebih menghargai sebuah kehidupan. Maka jangan biarkan lepas begitu saja tanpa peninggalan yang berarti"</i></h4>
