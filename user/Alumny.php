...
<link rel="stylesheet" href="js/DataTables-1.10.13/media/css/jquery.dataTables.css" type="text/css" media="screen" />

	

	<script src="js/jquery-1.11.1.min.js"></script>
	<script src="js/DataTables-1.10.13/media/js/jquery.dataTables.js"></script>
			...
			<!-- events -->
				...
				<div class="events">
					...
					$mysqli = new mysqli('127.0.0.1', 'root', '', 'citrabangsa');
										...
										//$data2 = $_GET['tanggal_ren'];
										$qstr = "SELECT * FROM alumny";
						...
						// echo "Res = " . $result;
										...
										echo		'<tr>'.
									'<td>'.$pengumuman['nama_alumny'].'</td>'.
									'<td>'.$pengumuman['nama_sekolah'].'</td>'.
