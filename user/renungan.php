			...
			<!-- events -->
				...
				<div class="events">
					...
					$mysqli = new mysqli('127.0.0.1', 'root', '', 'citrabangsa');
										...
										$qstr = "SELECT tbl_renungan.judul_ren, tbl_renungan.isi_ren, admin.Nam_admin FROM tbl_renungan INNER JOIN admin ON tbl_renungan.id_admin = admin.id_admin AND tanggal_ren ='$data2'";
						...
						echo '<div class="col-md-8 event-left">'.
							'<div class="event-left1">'.
								'<div class="col-xs-6 event-left1-left">'.
									'<a href="pengumuman.php"><img src="foto/alkitab.jpg" alt=" " class="img-responsive" /></a>'.
								...
								'<div class="col-xs-6 event-left1-right">'.
									...
									'</h4>'.
									'<h4>'.
									'<td>' . $pengumuman["isi_ren"] . '</td>' .
									'</a></h4>'.
									'<h4>'.
									'<td>' . $pengumuman["Nam_admin"] . '</td>' .
									'</h4>'.
								'</div>'.
								'<div class="clearfix"> </div>'.
							'</div>'.
