			...
			<!-- events -->
				...
				<div class="events">
					...
					$mysqli = new mysqli('127.0.0.1', 'root', '', 'citrabangsa');
										...
										$data2 = $_GET['tanggal'];
										$qstr = "SELECT tbl_informasi.judul, tbl_informasi.isi, admin.Nam_admin FROM tbl_informasi INNER JOIN admin ON tbl_informasi.id_admin = admin.id_admin AND tanggal ='$data2'";
						...
						echo '<div class="col-md-8 event-left">'.
							'<div class="event-left1">'.
								'<div class="col-xs-6 event-left1-left">'.
									'<a href="pengumuman.php"><img src="foto/2.jpg" alt=" " class="img-responsive" /></a>'.
