...
if(isset($_POST['simpan'])){
    ...
    $sql = mysql_query("INSERT INTO t_siswa(nis,nama)values 
		('$nis','$nama')");
    if($sql){
        ?>
        <script type="text/javascript">
...
<div class="tab-pane active" id="biodata">
    <table class="table table-bordered">
      ...
      <tr>
          ...
          <td>
              <div class="col-md-4">
              <input type='text' name='nis' placeholder='' class='form-control'  value='' >
              </div>
            </td>
        </tr>
			 <tr>
          ...
          <td>
              <div class="col-md-4">
              <input type='text' name='nama' placeholder='' class='form-control'  value='' >
              </div>
            </td>
        </tr>
    </table>
