...
<div class="tab-pane active" id="biodata">
  ...
  <tr>
			...
			?>
			<td> 
			<select name="nis" id="nis" type="text"  class="field size1"  required="required">
		 ...
		 <tr>
			...
			<?php
				 include 'koneksi.php';
				$query = "select * from t_matpel ";
				$result = mysql_query($query);
			?>
			<td> 
			<select name="kode_matpel" id="kode_matpel" type="text"  class="field size1"  required="required">
											 <option value="">-Matapelajaran-</option>
											 <?php while ($data = mysql_fetch_array($result)) 
													{ ?>
											 <option value='<?php echo $data['kode_matpel'] ?>'><?php echo $data['kode_matpel'] ?> | <?php echo $data['matpel'] ?></option>
											 <?php } ?>
										  </select>
			 </td>
		</tr>
		<tr>
          ...
          <td>
              <div class="col-md-4">
              <input type='text' name='nilai' placeholder='' class='form-control'  value='' >
              </div>
            </td>
        </tr>
...
if(isset($_POST['simpan'])){
    ...
    $sql = mysql_query("INSERT INTO t_nilai(nis,kode_matpel,nilai)values 
		('$nis','$kode_matpel','$nilai')");
    if($sql){
        ?>
