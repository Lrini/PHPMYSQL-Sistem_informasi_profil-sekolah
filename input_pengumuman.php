...
if(isset($_POST['simpan'])){
    ...
    $sql = mysql_query("INSERT INTO tbl_informasi(judul,isi,id_admin)
                        values ('$judul','$isi',$id_adm);
            ");
  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">            
              <!--overview start-->
              <div class="row">
      <form action="input_pengumuman.php" method="post" accept-charset="utf-8">
...
<div class="tab-pane active" id="biodata">
    <table class="table table-bordered">
        <tr class="success"><th colspan="2">INPUT PENGUMUMAN </th></tr>
        <tr>
          <td width="150">Judul pengumuman </td>
          <td>
            <div class='col-sm-4'>
              <input type='text' name='judul' value=""  class='form-control' required='required' >
            </div>             
        <tr>
          <td>Isi Pengumuan</td>
          <td><textarea name="isi" id="news"></textarea>
            <script type="text/javascript">
